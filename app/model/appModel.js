...
Station.getNiveau = function (stationName, result) {
    sql.query("select nom, niveauEau.valeur as valNiveau, niveauEau.reference as reference, longitude, latitude from station, niveauEau where station.id = niveauEau.idStation and nom = ? order by reference desc", stationName, function (err, res) {
